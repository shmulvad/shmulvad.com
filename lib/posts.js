...
import genHeadingIds from "./gen-heading-ids";
...
export async function getPostData(id) {
  const fullPath = path.join(postsDirectory, `${sanitize(id)}.md`);
  ...
  const contentHtml = genHeadingIds(replaceImagesWithOptimized(
