...
const resumeDescription =
  "Education, experience, extracurricular, courses, references. This page got it all.";
const missingPageDescription =
  "This is awkward... But the page could not be found.";
